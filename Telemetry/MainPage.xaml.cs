...
namespace Telemetry
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private const string IOT_HUB_CONN_STRING = "HostName=WillsIOTHub.azure-devices.net;DeviceId=WillsRPI2;SharedAccessKey=8C+eJxGQan0K28ykOvYRkJnvhbNd/AHkXynDY8Bo9Qg=";
        // Use the name of your Azure IoT device here - this should be the same as the name in the connections string
        private const string IOT_HUB_DEVICE = "WillsRPI2";
        // Provide a short description of the location of the device, such as 'Home Office' or 'Garage'
        private const string IOT_HUB_DEVICE_LOCATION = "Prague";
